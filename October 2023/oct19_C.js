/*
  ...
  Or
  filter() function of Array instances creates a shallow copy of a portion of a given array,
...
/*
  uparni rit ma aapne return statement lakhiyu che jo ae na lakhavu hoy to aene biji rite pn lakhi sakay
...
/*
  Output: 
  Objects which salary is greater then 25000: [
    { id: 1, name: 'abc', salary: 26000 },
    { id: 2, name: 'pqr', salary: 30000 },
    { id: 4, name: 'xyz', salary: 35000 }
  ]
